...
public class ReportsActivity extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reportsFragment = ReportsFragment.newInstance().newInstance();
        ...
        setActionBar();
        createMenuList();
        viewAnimator = new ViewAnimator<>(this, list, reportsFragment, drawerLayout, this);
    }
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        ...
        if (topPosition == 0) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, reportsFragment).commit();
