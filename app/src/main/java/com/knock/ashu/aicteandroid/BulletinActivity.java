...
public class BulletinActivity extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    public static Intent newIntent(Context context) {
        return new Intent(context, BulletinActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bulletinFragment = BulletinFragment.newInstance();
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.content_frame, bulletinFragment)
                .commit();
        ...
        setActionBar();
        createMenuList();
        viewAnimator = new ViewAnimator<>(this, list, bulletinFragment, drawerLayout, this);
    }
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        ...
        animator.start();
        if (topPosition == 0) {
            BulletinFragment bulletinFragment = BulletinFragment.newInstance();
            getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, bulletinFragment).commit();
