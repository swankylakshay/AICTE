...
public class AboutUsActivity extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBar();
        createMenuList();
        viewAnimator = new ViewAnimator<>(this, list, aboutUsFragment, drawerLayout, this);
    }
