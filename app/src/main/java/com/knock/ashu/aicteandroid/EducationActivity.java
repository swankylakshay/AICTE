...
public class EducationActivity extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    public static Intent newIntent(Context context) {
        return new Intent(context, EducationActivity.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBar();
        createMenuList();
        viewAnimator = new ViewAnimator<>(this, list, educationFragment, drawerLayout, this);
    }
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        ...
        if (topPosition == 0) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, educationFragment).commit();
