...
public class StatisticsActivity extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBar();
        createMenuList();
        viewAnimator = new ViewAnimator<>(this, list, statisticsFragment, drawerLayout, this);
    }
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        ...
        if (topPosition == 0) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, statisticsFragment).commit();
