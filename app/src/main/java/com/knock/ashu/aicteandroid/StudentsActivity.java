...
public class StudentsActivity extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.content_frame, studentsFragment)
                .commit();
        ...
        setActionBar();
        createMenuList();
        viewAnimator = new ViewAnimator<>(this, list, studentsFragment, drawerLayout, this);
    }
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        ...
        animator.start();
        if (topPosition == 0) {
            StudentsFragment studentsFragment = StudentsFragment.newInstance();
            getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, studentsFragment).commit();
